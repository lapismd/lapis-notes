...
| LN-ED-002 | `@lapis-notes/api` MUST export a concrete source-text file view which mounts the existing CodeMirror editor without defining Markdown rendering policy. |
