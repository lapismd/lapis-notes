...
| LN-ED-008 | The empty landing view MUST expose functional Create note and Go to file actions. Go to file MUST open the Design Core palette on the Files tab. Close MUST use the design-core leaf action. |
