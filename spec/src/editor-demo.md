...
| LN-ED-007 | The demo MUST adapt Design Core Explorer to the API vault for listing, active-file selection, create, open, rename, move, delete, persisted auto-reveal, and persisted show-hidden files. Dotted names MUST stay hidden unless that setting is on. |
