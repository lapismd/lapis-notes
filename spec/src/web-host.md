...
| LN-WEB-004 | The web session MUST load File Explorer, Markdown, Markdownlint, Search, and CV before metadata and layout restoration, then mount the shared `WorkspaceShell`. |
...
Markdownlint, File Explorer, Search, and CV, and then mounts the same
