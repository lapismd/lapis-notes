...
| LN-WEB-004 | The web session MUST load File Explorer, Markdown, Markdownlint, Search, and the optional enabled-by-default Roles plugin before metadata and layout restoration, then mount the shared `WorkspaceShell` around plugin-owned page presentation. |
