...
| LN-PKG-061 | `@lapis-notes/api` `WorkspaceLeaf.openFile` MUST snapshot history before target-view construction so eager compatibility views cannot replace the initiating state recorded for Back. |
