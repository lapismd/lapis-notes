...
| LN-PKG-004 | The web host, notebook, and unlisted plugins MUST NOT be added until their requirements are specified and tracked in `MIGRATION.md`. The Electron host, Markdown packages, workspace integration, and internal language service are the current authorized exceptions. |
...
| LN-PKG-017 | `@lapis-notes/markdown` MUST publicly export app-only Svelte components for All Properties, File Properties, Outline, Backlinks, and Outgoing Links as documented by their owning panel pages. The public Outline surface MUST preserve its LN-MD-022 tree geometry, including parent-aligned leaf children, without requiring consumer styling. The Storybook-local Tags component MUST preserve its LN-MD-024 parent-label-aligned child-hash trailing edges without being presented as a package export, and `@lapis-notes/workspace` MUST remain shell-only.                                                                                                                                                                                                                                                                                                                                                         |
