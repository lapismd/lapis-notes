...
| LN-PKG-047 | Active local persistence MUST use pinned Turso native or WASM packages. SQLite implementations MAY remain only as private read-only legacy importers or explicit degraded fallbacks. |
