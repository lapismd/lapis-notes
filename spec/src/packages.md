...
package. The shared markdown panel shell selects body, sidebar, and bottom-panel
paint from design-core's stable destination-host attributes, so package views
carry no cached placement state.
