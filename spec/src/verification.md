...
| LN-CAT-022  | storybook-catalog | Implemented | six All Properties layouts, isolated Docs, explicit consumer sources, focused plays, and pending baselines      |
...
| LN-GOV-008  | spec-governance   | Implemented | `AGENTS.md` panel workflow: isolated Autodocs and explicit consumer-usable Show Code sources                    |
...
| LN-ED-020   | editor-demo       | Implemented | Workspace/Panels/Markdown stories + six-surface All Properties spike + editor-demo integration                  |
