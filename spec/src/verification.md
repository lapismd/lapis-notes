...
| LN-CAT-022  | storybook-catalog | Implemented | six layouts, isolated 700px padding-free Docs, consumer sources, focused plays, and pending baselines            |
...
| LN-GOV-008  | spec-governance   | Implemented | `AGENTS.md` panel workflow: 700px padding-free Autodocs and consumer-usable Show Code sources                   |
