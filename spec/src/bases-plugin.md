...
| LN-BASE-011 | Governed Storybook coverage MUST exercise public table, cards, grouped-list, map-unavailable, unknown-view, workflow, schema/settings, editable-cell, a real editor shell with File Explorer and indexed Search, real file-view, Markdown-embed, and disable/restore scenarios. Every scenario MUST include interaction assertions and remain `visual-pending` until human review. |
