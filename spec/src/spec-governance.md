...
| LN-GOV-004 | The local gate MUST inspect the current VCS change (`jj` preferred, else git); CI MAY compare base and head revisions. Pull-request workflow commands MUST forward `--base` and `--head` directly to the repository wrapper without inserting a literal end-of-options separator.                                                                                                                                                                                                                                                   |
