...
| LN-GOV-026 | The spec-first map MUST route API storage to App Database, MetadataCache projection contributors to App Database and Plugin Model, and web changes to Web Host, Packages, and Architecture. Lapis Roles consumer stories MUST route to Roles Host Integration and Storybook Catalog.                                                                                                                                                                                                                                                                                                                                                                              |
