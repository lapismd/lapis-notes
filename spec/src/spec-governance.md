...
| LN-GOV-041 | The spec-first map MUST route Lapis package release workflows, Changesets configuration, release and local-consumer helper scripts, release documentation, and public package metadata to Packages and Specification Governance, with API, UI, Language Service, File Explorer, and Workspace package docs also routed to their owning architectural chapters. |
