...
| LN-MD-088 | Selecting an All Properties row MUST invoke `search:open-search-left-sidebar` with its escaped bracket-property query. Nested property rows MUST search their normalized property path. |
