...
| LN-DESK-039 | The agent-runtime host MUST expose provider model discovery through `desktop_agent_acp_models`. Discovery MUST read an agent's acpx model status from a disposable one-shot session and close that session without persistent state.                                                                                                                                                                                         |
