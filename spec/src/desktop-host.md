...
| LN-DESK-034 | The desktop ACP host MUST accept model and thinking on `desktop_agent_acp_start`. It MUST pass model to acpx `ensureSession`, apply thinking through acpx session configuration, and keep acpx out of the renderer.                                                                                                                                                                                                          |
