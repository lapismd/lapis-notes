...
| LN-BM-005 | Adding a bookmark MUST show a dialog with the type-specific target and an optional title. A CommandView MUST then list existing groups plus Root. An unmatched query MUST offer Create group. |
