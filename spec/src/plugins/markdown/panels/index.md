...
| LN-MD-011 | The sibling `lapis-plugins` Storybook MUST provide focused Markdown panel stories for All Properties, File Properties, Outline, Backlinks, Outgoing Links, and Tags. Lapis Notes Storybook MUST retain only profile and plugin-management integration coverage for the published Markdown package. |
