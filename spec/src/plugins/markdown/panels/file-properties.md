...
| LN-MD-114 | Frontmatter value completion MUST remain advisory: users can type and commit custom text, tag, alias, or multitext values while suggestions are visible. Tag, alias, and multitext labels MUST wrap within the value column instead of truncating or causing horizontal overflow.                                                                                |
