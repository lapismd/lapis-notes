...
| ID        | Requirement                                                                                                                                                                                                                                                                                                                                                                                                |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LN-MD-001 | The sibling `lapis-plugins` repository MUST own and ship `@lapis-notes/markdown`; Lapis Notes MUST consume its public npm package and retain only application-profile and host integration contracts. Markdownlint remains separately governed by its owning package specification. |
...
| LN-MD-010 | Living behavior, parity, and Storybook verification MUST be tracked with the Markdown package in the sibling `lapis-plugins` repository. Lapis Notes migration records MAY retain cutover evidence but MUST NOT become the plugin behavior authority. |
