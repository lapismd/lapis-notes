...
| LN-MD-111 | Activating a frontmatter property type control in Live Preview or File Properties MUST expose Mira's complete type-and-action menu. The menu MUST remain visible and hit-testable outside its property row, and type selection MUST continue through the existing Mira controller and Lapis property manager.                                                                                              |
