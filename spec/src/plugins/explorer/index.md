...
The Files palette tab lists workspace recents under Recent when the query
is empty. A typed query keeps today's path filter. Landing Go to file opens
that tab through `app:go-to-file`.
