...
| ID          | Requirement                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| LN-PLUG-001 | Extracted first-party plugins MUST use package directories named `plugin-*` in the sibling `lapis-plugins` monorepo, retain their `@lapis-notes/*` package names and runtime IDs, version independently, and report official provenance.                                                                                                                                                                                                                                                                                                           |
