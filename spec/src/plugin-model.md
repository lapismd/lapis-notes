...
| LN-PLUG-006 | Markdown, Search, Markdown Lint, File Explorer, Notifications, and Roles MUST default enabled and remain user-disableable. Problems and other declared infrastructure MAY remain required.                  |
