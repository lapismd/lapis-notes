...
const markdownPanelFamilies = [
  ...
  },
  {
    kind: "outline",
    title: "Outline",
    spec: "spec/src/markdown-plugin/panels/outline.md",
    publicSurface: "@lapis-notes/markdown",
  },
  {
    kind: "backlinks",
    title: "Backlinks",
    spec: "spec/src/markdown-plugin/panels/backlinks.md",
    publicSurface: "@lapis-notes/markdown",
  },
  {
    kind: "outgoing-links",
    title: "Outgoing Links",
    spec: "spec/src/markdown-plugin/panels/outgoing-links.md",
    publicSurface: "@lapis-notes/markdown",
  },
  {
    kind: "tags",
...
export const workspaceCatalog = [
  ...
  },
  {
    ...
    spec: "spec/src/markdown-plugin/panels/all-properties.md",
    publicSurface: "@lapis-notes/markdown",
  ...
  },
  {
    ...
    publicSurface: "@lapis-notes/lapis-plugin-cv-roles",
