...
| LE-08 | lapis-notes | Mira base CodeMirror shell via `file:../mira-mde/packages/mira`, Obsidian theme default, source-only language packs | LE-04 | Done | `pnpm spec:check`; `pnpm check`; api 567 tests; Storybook editor demo plays; focused visual update/compare 7/7 for `workspace-lapis-editor-demo-` | `qpqzrvzk` |
