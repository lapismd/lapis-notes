...
| `@lapis-notes/lapis-plugin-docs`           | In progress         | Sibling Core Docs plugin (notes, books, cards, FSRS). Desktop and web hosts register the plugin class. Coding practice deferred. |
