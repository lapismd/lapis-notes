...
| `@lapis-notes/roles`                        | Done (visual deferred) | Clean rename of the retained CV slice plus vault-native `role.md` records and Applications, Activity, Actions, prep/comments, and linked/tailored CV flows; Tasks and AI remain excluded, Search stays Search-owned, and governed package/root Storybook evidence passes. Baseline capture was deferred at user request. |
