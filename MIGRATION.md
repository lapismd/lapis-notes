...
- [x] Grouped All Properties movable-surface spike: middle/top tabs, stacked tabs, left/right sidebars, grouped bottom panel, and sidebar group; each uses one real panel in the minimal shell with focused interaction coverage
