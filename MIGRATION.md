...
| Spec governance + validation              | Done   | 257 one-concern requirements; spec tooling lives under `scripts/spec-validation/`; local QMD discovery auto-refreshes canonical Markdown with optional embeddings while generated indexes remain untracked                                      |
