...
| `@lapis-notes/file-explorer`                | Done (slice) | Reusable File Explorer plugin shared by Storybook and Electron; semantic current/new-tab activation maps to API workspace leaves; source-editor remains a Storybook-local fixture                                                   |
