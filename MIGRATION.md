...
| `@lapis-notes/ai`                           | In progress    | Bundled provider-agnostic AgentRuntime, Fake/ACP/optional native Codex adapters, and a Design Core chat panel; CV-domain MCP tools remain outside this package                                                                 |
