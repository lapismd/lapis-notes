...
| `@lapis-notes/cv`                           | Done (CV slice) | Canonical legacy normalization, lossless structured editing, recoverable invalid YAML, serialized autosave, browser WASM preview, and governed 7020 Storybook; Applications remain later and Search does not index `*.cv.yml` |
