...
| Spec governance + validation              | Done   | 252 one-concern requirements; modular `spec:validate` enforces indexing, traceability, 80-word/four-sentence limits, ID-scoped acceptance lists, deterministic diagnostics, and untracked mdBook output; validator tests run in repo checks                  |
