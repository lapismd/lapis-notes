...
| Spec governance + validation              | Done   | 252 one-concern requirements; all spec scripts and tests live under `scripts/spec-validation/`; modular `spec:validate` enforces indexing, traceability, readability limits, acceptance lists, deterministic diagnostics, and untracked mdBook output      |
| Storybook host (port 7010)                | Done   | `API/` verification stories + catalog                                                                                                                                                                                                               |
| Storybook consumer Show Code              | In progress | Markdown panel families use explicit public/fixture sources; `API/*` demo-component Docs still need consumer-usable source overrides                                                                                                           |
