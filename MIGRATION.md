...
- [x] Stable incremental before/after match context, workspace-painted result bodies, public yellow highlight tokens, faint sans-serif counts, and body-hosted Search preservation during result navigation
