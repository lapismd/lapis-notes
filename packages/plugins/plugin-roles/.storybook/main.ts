...
const rolesLib = path.join(packageDir, "src/lib");
const rolesSrc = path.join(packageDir, "src");
        ...
        alias: [
          {
            ...
            replacement: path.join(storybookDir, "turso-wasm-stub.ts"),
          },
          {
          ...
          },
          {
            ...
            replacement: path.join(rolesLib, "index.ts"),
          },
          {
