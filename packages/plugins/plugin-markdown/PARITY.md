...
| Backlinks / Outgoing Links                         | Done           | Full-width titleless 0.75rem result surfaces with one trailing count edge; tested linked/unlinked mention model, grouping, search, sort, context, collapse, navigation, refresh, and shared app-bound Mira `FileEmbed` hover previews                                                                                                                                                                                                                                                                                             |
