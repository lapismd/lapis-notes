...
| Backlinks / Outgoing Links                         | Done           | Full-width titleless 0.75rem result surfaces with one trailing count edge; tested linked/unlinked mention model, grouping, search, sort, context, collapse, navigation, refresh, and shared app-bound Mira `FileEmbed` previews inside Design Core Hover Card with owner-document portals, native collision handling, topmost cross-pane paint, and interactive safe pointer handoff. Ordinary document links retain the Lapis adapter while Mira owns their portaled Bits UI preview.                                            |
| Portable embed framework                           | Done           | Public root and `./embed` `FileEmbed`, `MarkdownEmbed`, and `NoteLink`; Lapis `MiraFileAdapter` supplies vault-relative resolution, Markdown refresh, navigation, image/custom embed lifecycle, file/headings catalogs, and shared reading/live-preview behavior                                                                                                                                                                                                                                                                  |
