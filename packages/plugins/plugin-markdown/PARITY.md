...
| Tags sidebar                                       | Done           | Storybook-local app-only `TagsDemoPlugin` with parent-label-aligned Lucide child hashes, per-file hierarchy counts, sorting, search, nested disclosure, live refresh, full-width titleless content, shared panel typography, and one trailing count edge                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
