...
## Current slice status (2026-08-11)
...
metadata write authority. Spec: `spec/src/markdown-plugin.md` plus the nested
`spec/src/markdown-plugin/panels/` pages (LN-MD-001–081); the shared surface
...
| Markdown settings (Mira features + mermaid/AI)     | Done           | Flat descriptor-driven schema and runtime gates; the 20 capability flags render as a described design-core toggle table while toolbar, plugin, and extension controls remain ordinary Markdown settings |
...
| Tags sidebar                                       | Done           | Storybook-local app-only `TagsDemoPlugin` with Lucide child-hash trailing edges aligned to parent labels, per-file hierarchy counts, sorting, search, nested disclosure, live refresh, full-width titleless content, shared panel typography, and one trailing count edge                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
